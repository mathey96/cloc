...
const font font_standard_font = {"standard font", &font_standard, &calculate_offset_standard, &offset_before_twodots_standard, &offset_after_twodots_standard, 7, NO_OFFSET, 60, 15};
...
const font font_mini_font     = {"mini font", &font_mini, &calculate_offset_mini, &offset_before_twodots_mini, &offset_after_twodots_mini, 4, 15, 65, 15};
const font font_lean_font     = {"lean font", &font_lean, &calculate_offset_lean, &offset_before_twodots_lean, &offset_after_twodots_lean, 6, -5, 77, 15};
const font font_mono12_font   = {"mono12 font", &font_mono12, &calculate_offset_mono12, &offset_before_twodots_mono12, &offset_after_twodots_mono12, 8, -10, 85, 15 };
const font font_smmono12_font = {"smmono12 font", &font_smmono12, &calculate_offset_smmono12, &offset_before_twodots_smmono12, &offset_after_twodots_smmono12, 8, NO_OFFSET, 80, 15};
const font font_smscript_font = {"smscript font", &font_smscript, &calculate_offset_smscript, &offset_before_twodots_smscript, &offset_after_twodots_smscript, 5, 5, 75, 15};
const font font_smshadow_font = {"smshadow font", &font_smshadow, &calculate_offset_smshadow, &offset_before_twodots_smshadow, &offset_after_twodots_smshadow, 4, 5, 70, 15};
const font font_smslant_font  = {"smslant font", &font_smslant, &calculate_offset_smslant, &offset_before_twodots_smslant, &offset_after_twodots_smslant, 5, 5, 90, 15};
